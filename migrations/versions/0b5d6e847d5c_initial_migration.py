...
Revision ID: 0b5d6e847d5c
Revises: 
Create Date: 2024-01-02 11:05:51.304908
...
def upgrade():
    ...
    op.create_table('current_round_cats',
    sa.Column('user_pk', sa.Integer(), nullable=True),
    ...
    op.create_table('next_round_cats',
    sa.Column('user_pk', sa.Integer(), nullable=True),
    sa.Column('pk', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=255), nullable=False),
    sa.Column('created_on', sa.DateTime(), server_default=sa.text('now()'), nullable=True),
    ...
    sa.ForeignKeyConstraint(['cat_pk'], ['current_round_cats.pk'], ),
...
def downgrade():
    ...
    op.drop_table('next_round_cats')
    op.drop_table('current_round_cats')
